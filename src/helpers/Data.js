...
import ajmer from "../assets/ajmer.jpeg";
...
export const IntroData = {
  ...
  p2: "Ministery of Education’s Innovation Cell has envisioned encouraging creation of ‘Institution’s Innovation Council (IICs)’ across selected HEIs. A network of these IICs will be established to promote innovation in the Institution through multitudinous modes leading to an innovation promotion eco-system in the campuses. IIC has been established to systematically foster the culture of innovation in the institute. IICs are responsible for conducting the activities as per activity calendar provided by MHRD Innovation Cell.",
};
